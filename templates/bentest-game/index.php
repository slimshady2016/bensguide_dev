...
<script type="text/javascript" language="javascript" src="<?php echo JURI::base(); ?>templates/bentest-game/js/jquery.colorbox-min.js"></script>
...
jQuery(document).ready(function () {
   ...
   jQuery('a').not( ".newwindow" ).bind('click touchstart tap', function(e) {
