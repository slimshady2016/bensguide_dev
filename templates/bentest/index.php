...
<head>
 ...
 <meta name="viewport" content="width=device-width, initial-scale = 1.0, maximum-scale=1.0, user-scalable=no" />
    ...
    <!--Load of CSS -->
    <link rel="stylesheet" href="<?php echo $this->baseurl?>/templates/<?php echo $this->template ?>/js/fancybox/jquery.fancybox.css" type="text/css" />
    ...
    <script><!--Renders HTML5 elements in IE8-->
         ...
         <script src="<?php echo $this->baseurl ?>/templates/<?php echo $this->template ?>/js/Tocca.min.js"></script>
...
<!-- Header Wrapper -->
    <div id="header-wrapper">
        ...
        <div class="container">
           <div class="ben">
                        <div class="badge">
                        	<a  href="learning-adventures-14more?id=36&age=ben4_8"><img src="/templates/bentest/images/appenties.png" alt="" /></a>
                            <a  href="learning-adventures-14more?id=38&age=ben9_13"><img src="/templates/bentest/images/journeyman.png" alt="" /></a>
                            <a  href="learning-adventures-14more?id=39&age=ben14more"><img src="/templates/bentest/images/master.png" alt="" /></a>
                        </div>
                        <img class="ben-avatar" src="<?php echo $this->baseurl?>/templates/bentest/images/ben.png" alt="" />
                    </div><!-- END ben -->
        </div><!-- END container -->
