...
.red {
	...
	<div id="installer-right">
		...
		<?php if ($messages['modules']) { ?>
			...
			<?php } ?>
		<?php } ?>
		<h2>Changelog v1.51.12</h2>
		<ul class="version-history">
			<li><span class="version-upgraded">Upg</span> Placeholders dropdown re-worked.</li>
			<li><span class="version-upgraded">Upg</span> Separated 'Responsive' layout from front.css into its own stylesheet.</li>
			<li><span class="version-upgraded">Upg</span> 'Responsive' Layout CSS definitions were missing for '&lt;input&gt;' buttons.</li>
			<li><span class="version-upgraded">Upg</span> Button Type now defaults to '&lt;button&gt;' for 'Submit Button' and 'Button' fields.</li>
			<li><span class="version-upgraded">Upg</span> Can restore backups in .tar or .tar.gz format.</li>
			<li><span class="version-upgraded">Upg</span> Can now set 'Timepicker format' in 'Date and Time Picker' field.</li>
			<li><span class="version-fixed">Fix</span> Calculations were not working correctly if field 'Name' contained a hyphen.</li>
			<li><span class="version-fixed">Fix</span> 'Minimum Date' modifier on 'Calendar' field now changes month to reflect minimum date.</li>
			<li><span class="version-fixed">Fix</span> AJAX Validation was not working in some cases due to a script error.</li>
		</ul>
