...
<table width="100%" class="com-rsform-table-props">
	...
	<tr>
		...
		<td>
			<input data-delimiter=" " data-placeholders="display" name="from" data-filter-type="include" data-filter="value,global" class="rs_inp rs_80" id="from" value="<?php echo $this->escape($this->row->from); ?>" size="35" style="width:330px;" />
		</td>
	</tr>
	<tr>
		...
		<td>
			<input data-delimiter=" " data-placeholders="display" name="fromname" class="rs_inp rs_80" id="fromname" value="<?php echo $this->escape($this->row->fromname); ?>" size="35" style="width:330px;" />
		</td>
	</tr>
	<tr>
		<td width="25%" align="right" nowrap="nowrap" class="key"><?php echo JText::_('RSFP_EMAILS_REPLY_TO'); ?>:</td>
		<td><input data-delimiter=" " data-placeholders="display" data-filter-type="include" data-filter="value,global" name="replyto" class="rs_inp rs_80" id="replyto" value="<?php echo $this->escape($this->row->replyto); ?>" style="width:330px;" /></td>
	</tr>
	<tr>
		<td width="25%" align="right" nowrap="nowrap" class="key"><span style="color: red"><?php echo JText::_('RSFP_EMAILS_TO'); ?></span></td>
		<td><input data-delimiter="," data-placeholders="display" data-filter-type="include" data-filter="value,global" name="to" class="rs_inp rs_80" id="to" value="<?php echo $this->escape($this->row->to); ?>" style="width:330px;" /></td>
	</tr>
	<tr>
		<td width="25%" align="right" nowrap="nowrap" class="key"><?php echo JText::_('RSFP_EMAILS_CC'); ?></td>
		<td><input data-delimiter="," data-placeholders="display" data-filter-type="include" data-filter="value,global" name="cc" class="rs_inp rs_80" id="cc" value="<?php echo $this->escape($this->row->cc); ?>" style="width:330px;" /></td>
	</tr>
	<tr>
		<td width="25%" align="right" nowrap="nowrap" class="key"><?php echo JText::_('RSFP_EMAILS_BCC'); ?></td>
		<td><input data-delimiter="," data-placeholders="display" data-filter-type="include" data-filter="value,global" name="bcc" class="rs_inp rs_80" id="bcc" value="<?php echo $this->escape($this->row->bcc); ?>" style="width:330px;" /></td>
	</tr>
	<tr>
		...
		<td><input data-delimiter=" " data-placeholders="display" name="subject" class="rs_inp rs_80" id="subject" value="<?php echo $this->escape($this->row->subject); ?>" style="width:330px;" /></td>
	</tr>
	<tr>
