...
<input class="yee-btn yee-btn-default yee-btn-info" type="button" value="<?php echo JText::_('YEEDITOR_WIDGET_SETTING_SELECT_MEDIA');?>" onclick="select_image('<?php echo $element_param['param_name'];?>');"/>
