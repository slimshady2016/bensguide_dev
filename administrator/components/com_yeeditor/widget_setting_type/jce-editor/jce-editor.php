...
(function($){
	$(function() {
		...
		IframePost.doPost({ Url: yee_root+"index.php?option=com_yeeditor&view=yeeditor_transverter&tmpl=component&layout=jce-editor", Target:{name:"<?php echo $element_param['param_name'];?>_iframe"}, PostParams: { input_name:'<?php echo $element_param['param_name'];?>', content:$('textarea[name="<?php echo $element_param['param_name'];?>"]').val() } });
