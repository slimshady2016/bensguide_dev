 ...
 * @since       1.6
 */
class YeeditorViewTemplates extends JViewLegacy
{
    protected $widgets;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('Yeeditor Manager: Templates'), 'banners.png');
		...
		JToolBarHelper::deleteList('', 'templates.remove', 'JTOOLBAR_DELETE');		
	}
}
