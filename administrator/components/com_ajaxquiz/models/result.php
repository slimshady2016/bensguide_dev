...
class AjaxquizModelResult extends JModelList
{
	/**
	...
	protected function getListQuery()
	{
		...
		$query->from($db->quoteName('#__ajaxquiz_result').' AS a');		
	...
	// Filter by category.
                ...
                if (is_numeric($categoryId)) {
				 ...
				 $orderCol       = $this->state->get('list.ordering', 'a.score');
	 ...
	 * @since	1.6
	 */
	public function getTable($type = 'Result', $prefix = 'AjaxquizTable', $config = array())
	{
	...
	public function remove($cid) {
		if (count( $cid ))
                {
                        $cids = implode( ',', $cid );
                        $query = 'DELETE FROM #__ajaxquiz_result'
                                        . ' WHERE id IN ('. $cids .')';
                ...
                return $msg;
                        ...
                        $total  = count( $cid );
                        $msg    = $total.' '.JText::_('RESULT DELETED');
                        return $msg;
                }   
	}
	...
	protected function populateState($ordering = null, $direction = null)
        {
                ...
                parent::populateState('a.score', 'asc');
        }
