...
$canOrder	= $user->authorise('core.edit.state', 'com_ajaxquiz.category');
...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_ajaxquiz&task=categories.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_ajaxquiz&view=categories'); ?>" method="post" name="adminForm" id="adminForm">
			...
			<thead>
				<tr>
					...
					<th width="30%" class="nowrap center hidden-phone">
						<?php echo JHtml::_('grid.sort', 'DURATION', 'a.duration', $listDirn, $listOrder); ?>
					</th>
					<th width="1%" class="nowrap center hidden-phone">
			...
			//	$canCheckin = $user->authorise('core.manage',     'com_checkin') || $item->checked_out == $userId || $item->checked_out == 0;
				...
				<tr class="row<?php echo $i % 2; ?>" sortable-group-id="0">
					...
					<td class="nowrap has-context">
						<div class="pull-left">
								<a href="<?php echo JRoute::_('index.php?option=com_ajaxquiz&task=category.edit&id='.(int) $item->id); ?>">
